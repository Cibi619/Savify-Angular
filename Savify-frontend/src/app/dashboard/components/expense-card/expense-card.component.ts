...
@Component({
  ...
  standalone: true,
  imports: [CurrencyPipe, NgStyle, AddExpenseModalComponent],
...
export class ExpenseCardComponent implements OnInit {
  ...
  @Output() limitUpdated = new EventEmitter<{ category: string; limit: number }>();
  ...
  onLimitUpdated(newLimit: number) {
    this.limitUpdated.emit({ category: this.category, limit: newLimit });
